...
// Step 1: Add offsetX to renderVideoPlayerMockup
code = code.replace(
...
// Step 2: Intercept isVideoCard at the start and return a premium SVG
const interceptCode = `
...
code = code.replace(/const isVideoCard = type === 'video';/g, interceptCode);

// There is another reference of `isVideoCard` below that we should let be or it will be skipped anyway.
fs.writeFileSync('server.ts', code);
console.log("Re-wrote isVideoCard layout.");
