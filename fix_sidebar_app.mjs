...
sidebar = sidebar.replace(/import \{ useTranslation \} from "\.\.\/i18n\/translations";/g, 'import { useLanguage } from "../i18n/LanguageContext";');
sidebar = sidebar.replace(/import \{ t \} from "\.\.\/i18n\/translations";/g, 'import { useLanguage } from "../i18n/LanguageContext";');
