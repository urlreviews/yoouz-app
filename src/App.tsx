...
export function App() {
  ...
  return (
    ...
    >
      ...
      <div className={`flex-1 flex flex-col relative overflow-hidden bg-zinc-950 md:bg-zinc-950 ${(activeSection === "business" || activeSection === "admin") ? "h-[100dvh]" : "h-mobile-stage"}`}>
