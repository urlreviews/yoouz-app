      ...
      >
        ...
        <div className="px-5 py-3.5 border-b border-zinc-800 flex items-center justify-between shrink-0 bg-zinc-900">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="font-bold text-white text-base leading-tight">Share & Embed</h3>
        ...
        {/* Tab Selection */}
        <div className="px-5 pt-3 pb-1 bg-zinc-900 flex items-center gap-2 border-b border-zinc-800">
          <button
            ...
            <div className="space-y-4">
              <div className="p-3.5 rounded-xl bg-blue-950/30 border border-blue-800/50 flex items-start gap-2.5">
                ...
                <div className="text-xs text-blue-200/90 leading-relaxed">
                  <span className="font-bold text-white">Embed 60s Video on Your Website:</span> Paste this code into your CMS (WordPress, Shopify, Webflow, Squarespace) or HTML to display a verified video player that boosts conversions by 3x.
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between">
                  <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-wider">Embed Code (HTML iFrame)</p>
                  {embedCopied && (
                    <span className="text-[11px] font-bold text-emerald-400 animate-in fade-in flex items-center gap-1">
                      <Check className="w-3.5 h-3.5" /> Code copied to clipboard!
                    </span>
                  )}
                </div>
              ...
              <div className="pt-2">
                ...
                <div className="rounded-2xl border border-zinc-800 bg-zinc-950 overflow-hidden shadow-2xl flex justify-center p-2">
                  <iframe
                    src={embedUrl}
                    title="Yoouz Embed Preview"
                    className="w-[280px] h-[400px] rounded-xl border-0 bg-black"
                    loading="lazy"
                  />
                </div>
              </div>
