    ...
    <div className="fixed inset-0 h-[100dvh] z-[250] bg-zinc-950 text-white flex flex-col font-sans animate-in slide-in-from-bottom duration-200">
      ...
      <div className="px-3.5 pt-3.5 pb-3 border-b border-zinc-800 bg-zinc-950/95 backdrop-blur-md sticky top-0 z-30 shadow-sm">
        <form 
          ...
          className="w-full"
        >
          <div className="relative flex items-center bg-zinc-900 rounded-full border border-zinc-800 focus-within:border-zinc-600 focus-within:ring-2 focus-within:ring-white/10 transition-all shadow-xs px-3.5 py-2.5">
      ...
      <div className="flex-1 min-h-0 overflow-y-auto p-4 pb-48 overscroll-contain">
        ...
        {isSearching ? (
          ...
          <div className="flex flex-col items-center justify-center pt-16 pb-12 text-center px-4 animate-in fade-in duration-300">
            <div className="w-14 h-14 rounded-2xl bg-zinc-900 border border-zinc-800 text-zinc-300 flex items-center justify-center mb-3.5 shadow-xs">
            ...
            <div className="bg-zinc-900 rounded-3xl border border-zinc-800 shadow-md overflow-hidden mb-6">
              ...
              <div className="px-5 pb-6 relative z-10">
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noreferrer" 
                  className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-zinc-800 hover:bg-zinc-700 text-zinc-300 text-xs font-semibold mt-2.5 transition-colors border border-zinc-700/60"
                >
                ...
                <button
                  ...
                  className="w-full mt-5 bg-white hover:bg-zinc-200 active:scale-[0.98] text-zinc-950 py-3.5 rounded-full font-extrabold text-sm shadow-md flex items-center justify-center gap-2 transition-all cursor-pointer"
                >
            ...
            <div>
              ...
              {placeVideos.length > 0 ? (
                    ...
                    >
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent flex flex-col justify-end p-2.5">
                        <div className="flex items-center gap-0.5 mb-1">
                          {[...Array(5)].map((_, i) => (
                            <Star key={i} className={`w-2.5 h-2.5 ${i < video.rating ? "text-white fill-current" : "text-zinc-600"}`} />
                          ))}
                        </div>
                ...
                <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 text-center shadow-xs">
                  <div className="w-10 h-10 rounded-full bg-zinc-800 text-zinc-300 flex items-center justify-center mx-auto mb-2.5 border border-zinc-700">
                  ...
                  <button
                    ...
                    className="text-xs font-bold text-white bg-zinc-800 border border-zinc-700 px-4 py-2 rounded-full hover:bg-zinc-700 shadow-xs transition-all cursor-pointer"
                  >
