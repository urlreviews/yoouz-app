...
export const CopoFollowingView: React.FC<CopoFollowingViewProps> = ({
  ...
  return (
    <div className="flex-1 h-full overflow-y-auto bg-zinc-950 text-white p-3.5 sm:p-6 select-none">
      <div className="max-w-4xl mx-auto space-y-4 sm:space-y-6 pb-32 md:pb-6">
        {/* Header section matching Native Style */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-zinc-900 p-4.5 sm:p-6 rounded-3xl border border-zinc-800 shadow-2xs">
          ...
          <div className="flex items-center justify-around sm:justify-center gap-4 bg-zinc-950 border border-zinc-800 rounded-2xl px-5 py-2.5 shrink-0">
            <div className="text-center pr-4 border-r border-zinc-800">
              ...
              <p className="text-base sm:text-lg font-black text-white">{followedAuthors.length + followedPlaces.length}</p>
            </div>
        ...
        <div className="flex items-center border border-zinc-800 bg-zinc-900 p-1 rounded-2xl shadow-2xs overflow-x-auto no-scrollbar">
          <button
        ...
        <div className="space-y-6">
          ...
          {activeTab === "activity" && (
            <div className="space-y-4">
              {activityFeed.length === 0 ? (
                <div className="p-12 rounded-3xl bg-zinc-900 border border-zinc-800 text-center text-zinc-400 space-y-4 shadow-2xs">
                  <div className="w-16 h-16 rounded-full bg-zinc-800 text-zinc-300 flex items-center justify-center mx-auto">
                    <Sparkles className="w-8 h-8" />
                  </div>
                  <div className="max-w-md mx-auto space-y-2">
                    <p className="text-base font-bold text-white">No updates from followed accounts yet</p>
                  ...
                  <div className="pt-2">
                    <button
                      onClick={() => setActiveTab("guides")}
                      className="px-5 py-2.5 rounded-full bg-white hover:bg-zinc-200 text-zinc-950 font-bold text-xs inline-flex items-center gap-2 transition-colors cursor-pointer shadow-sm"
                    >
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                  {activityFeed.map((video) => (
                    <div
                      ...
                      className="group relative aspect-[9/15] rounded-3xl overflow-hidden bg-black border border-zinc-800 cursor-pointer hover:border-zinc-500 hover:shadow-md transition-all animate-in fade-in duration-300"
                    >
                      {video.thumbnailUrl ? (
                        <img
                      ...
                      <div className="absolute top-2.5 left-2.5 right-2.5 flex items-center justify-between">
                        ...
                        <div className="px-2 py-1 rounded-full bg-black/70 border border-white/10 backdrop-blur-xs text-white text-[9.5px] font-black flex items-center gap-0.5 shadow-sm">
              ...
              {suggestedAuthors.length > 0 && (
                <div className="pt-4 space-y-3">
                  <h3 className="text-xs sm:text-sm font-bold text-zinc-200 flex items-center gap-1.5 px-1">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {suggestedAuthors.slice(0, 2).map((author) => (
                      <div
                        ...
                        className="p-3.5 sm:p-4 bg-zinc-900 border border-zinc-800 rounded-2xl flex items-center justify-between gap-3 shadow-2xs hover:border-zinc-700 transition-colors"
                      >
                        <div
                        ...
                        <button
                          ...
                          className="shrink-0 px-3.5 py-1.5 rounded-full bg-white hover:bg-zinc-200 text-zinc-950 font-extrabold text-[11px] sm:text-xs inline-flex items-center gap-1 cursor-pointer transition-colors shadow-2xs whitespace-nowrap active:scale-95"
                        >
          ...
          {activeTab === "guides" && (
            <div className="space-y-4 animate-in fade-in duration-200">
              ...
              <div className="flex border-b border-zinc-800 text-xs font-bold text-zinc-400 gap-5 sm:gap-6 overflow-x-auto no-scrollbar">
                <button
                  ...
                  className={`pb-3 border-b-2 cursor-pointer transition-colors outline-none focus:outline-none whitespace-nowrap ${
                    guideSubTab === "following" ? "border-white text-white font-extrabold" : "border-transparent text-zinc-400 hover:text-zinc-200"
                  }`}
                >
                ...
                <button
                  ...
                  className={`pb-3 border-b-2 cursor-pointer transition-colors outline-none focus:outline-none whitespace-nowrap ${
                    guideSubTab === "followers" ? "border-white text-white font-extrabold" : "border-transparent text-zinc-400 hover:text-zinc-200"
                  }`}
                >
                ...
                <button
                  ...
                  className={`pb-3 border-b-2 cursor-pointer transition-colors outline-none focus:outline-none whitespace-nowrap ${
                    guideSubTab === "suggestions" ? "border-white text-white font-extrabold" : "border-transparent text-zinc-400 hover:text-zinc-200"
                  }`}
                >
                  Recommended
                </button>
                ...
                <div className="space-y-3">
                  {followedAuthors.length === 0 ? (
                    <div className="p-8 sm:p-10 rounded-2xl bg-zinc-900 border border-zinc-800 text-center text-zinc-400 space-y-2">
                      <p className="font-bold text-white text-xs sm:text-sm">You aren't following any local guides yet</p>
                      <p className="text-xs text-zinc-400">Follow local reviewers to track their dining and venue insights.</p>
                      {suggestedAuthors.length > 0 && (
                        <div className="pt-2">
                          <button
                            onClick={() => setGuideSubTab("suggestions")}
                    ...
                    <div className="space-y-3">
                      {followedAuthors.map((author) => (
                        ...
                        >
                          ...
                          <button
                            onClick={() => onToggleFollow(author.name)}
                            className="shrink-0 px-3.5 py-1.5 sm:px-4 sm:py-2 rounded-full bg-zinc-800 hover:bg-zinc-700 text-zinc-200 border border-zinc-700 font-extrabold text-[11px] sm:text-xs inline-flex items-center gap-1 transition-all cursor-pointer shadow-2xs whitespace-nowrap active:scale-95"
                          >
              ...
              {guideSubTab === "followers" && (
                <div className="p-8 sm:p-12 rounded-3xl bg-zinc-900 border border-zinc-800 text-center text-zinc-400 space-y-3 shadow-2xs animate-in fade-in duration-200">
              ...
              {guideSubTab === "suggestions" && (
                <div className="space-y-3">
                  {suggestedAuthors.length === 0 ? (
                    <div className="p-8 sm:p-10 rounded-2xl bg-zinc-900 border border-zinc-800 text-center text-zinc-400 space-y-2">
                      <p className="font-bold text-white text-xs sm:text-sm">No recommended guides right now</p>
                      <p className="text-xs text-zinc-400">Record reviews or explore local businesses to connect with creators.</p>
                    </div>
                  ) : (
                    suggestedAuthors.map((author) => (
                      <div
                        key={`guide-suggest-${author.name}`}
                        className="p-3.5 sm:p-4 bg-zinc-900 border border-zinc-800 rounded-2xl flex items-center justify-between gap-3 shadow-2xs hover:border-zinc-700 transition-colors animate-in fade-in duration-200"
                      >
                        <div
                          onClick={() => onOpenCreator(author)}
                          className="flex items-center gap-3 min-w-0 flex-1 cursor-pointer group"
                        ...
                        <button
                          onClick={() => onToggleFollow(author.name)}
                          className="shrink-0 px-3.5 py-1.5 sm:px-4 sm:py-2 rounded-full bg-white hover:bg-zinc-200 text-zinc-950 font-extrabold text-[11px] sm:text-xs inline-flex items-center gap-1.5 transition-colors cursor-pointer shadow-2xs whitespace-nowrap active:scale-95"
                        >
                          <UserPlus className="w-3.5 h-3.5" />
                          <span>Follow</span>
                        </button>
            ...
            <div className="space-y-5 animate-in fade-in duration-200">
              <div className="space-y-3">
                {followedPlaces.length === 0 ? (
                  <div className="p-10 rounded-2xl bg-zinc-900 border border-zinc-800 text-center text-zinc-400 space-y-4 shadow-2xs">
                    <div className="w-12 h-12 rounded-full bg-zinc-800 text-zinc-300 flex items-center justify-center mx-auto">
                      <MapPin className="w-6 h-6" />
                    </div>
                    <div className="max-w-xs mx-auto space-y-1">
                      <p className="font-bold text-white text-sm">No followed businesses yet</p>
                      <p className="text-xs text-zinc-400">Follow restaurants, bakeries, or shops to track their updates and customer response posts.</p>
                    </div>
                  </div>
                ) : (
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {followedPlaces.map((place) => (
                      <div
                        ...
                        className="p-4 bg-zinc-900 border border-zinc-800 rounded-2xl flex flex-col justify-between shadow-2xs hover:border-zinc-700 transition-colors gap-3"
                      >
                        <div
                        ...
                        >
                          ...
                          />
                          <div className="min-w-0 flex-1 text-left">
                            <h4 className="font-bold text-xs sm:text-sm text-white group-hover:text-zinc-200 transition-colors truncate">
                              {place.name}
                            </h4>
              ...
              {suggestedPlaces.length > 0 && (
                <div className="pt-4 space-y-3">
                  <h3 className="text-sm font-bold text-zinc-200 flex items-center gap-1.5 px-1">
