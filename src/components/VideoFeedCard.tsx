...
export const VideoFeedCard: React.FC<VideoFeedCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div 
        className="absolute top-0 left-0 right-0 z-50 flex items-center justify-between px-3 md:px-4 pt-[max(16px,calc(env(safe-area-inset-top,0px)+4px))] md:pt-4 pointer-events-none"
      >
