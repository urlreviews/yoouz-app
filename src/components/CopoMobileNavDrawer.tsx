        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden px-4 py-3 space-y-4 divide-y divide-zinc-800/60">
          ...
          <div className="pt-4">
            <button
              ...
              className="w-full flex items-center justify-center gap-2.5 py-3.5 px-4 rounded-2xl bg-zinc-900 hover:bg-zinc-800 hover:border-zinc-500 text-white font-bold text-sm shadow-lg shadow-black/40 border border-zinc-700/80 transition-all cursor-pointer active:scale-95"
            >
